...
const Homepage = () => {
  ...
  const { mutate: sendRequestMutation, variables: pendingUserId, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      // Optionally also refresh the users list if the backend changes their returned state
      ...
      <div className="container mx-auto space-y-10">
        ...
        <section>
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row items-start smitems-center justify-between gap-4">
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                ...
                return (
                  <div
                    key={user._id}
                    className="card bg-base-200 hover:shadow-lg transation-all duration-300">

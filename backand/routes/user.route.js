...
import { acceptFriendRequest, getFriendRequest, getMyFriends, getOutgoingFriendRequest, getRecommendedUsers, sendFriendRequest, unfriendUser } from "../controler/user.controler.js";
...
userRouter.delete("/friend/:id", unfriendUser);
